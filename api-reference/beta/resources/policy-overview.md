...
| [servicePrincipalCreationPolicies](serviceprincipalcreationpolicy.md)                     | Represents a set of policies that describe the conditions under which the permission to create service principals can be granted.                                                                 | Create a custom directory role including the _limited_ permission to create service principals subject to a service principal creation policy. |
