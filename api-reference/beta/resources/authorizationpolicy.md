...
| [Update defaultUserRoleOverride](../api/defaultuserroleoverride-update.md)| None |Update a [defaultUserRoleOverride](../resources/defaultuserroleoverride.md) object. A **defaultUserRoleOverride** can be updated to customize [users' default permissions](/azure/active-directory/fundamentals/users-default-permissions) in an organization, or to revert back to Microsoft's default setting. |
