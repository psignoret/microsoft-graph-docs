...
| createdDateTime | DateTimeOffset | The time this app role assignment was created. Read-only. |
| lastModifiedDateTime | DateTimeOffset | The time this app role assignment was last updated. Read-only. |
