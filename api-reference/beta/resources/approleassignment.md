...
| createdDateTime | DateTimeOffset | The time when the app role assignment was created. Read-only. |
| creationTimestamp | DateTimeOffset | The time when the app role assignment was created. Read-only. |
| id | String | A unique identifier for the **appRoleAssignment** Key. Not nullable. Read-only. |
| lastModifiedDateTime | DateTimeOffset | The time when the app role assignment was last updated. Read-only. |
